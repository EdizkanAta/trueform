...
|---|---|---|---|---|---|---|---|
| barbell-bench-press | Barbell Bench Press | chest, triceps, shoulders | ✅ alias | 0025 | gif |  | ExerciseDB id=0025 "barbell bench press" via RapidAPI |
| dumbbell-bench-press | Dumbbell Bench Press | chest, triceps, shoulders | ✅ alias | 0289 | gif |  | ExerciseDB id=0289 "dumbbell bench press" via RapidAPI |
| push-up | Push-Up | chest, triceps, shoulders | 🖼️ poster (reviewed) |  | poster |  | No faithful ExerciseDB demo — static poster + cues (reviewed). |
| overhead-press | Overhead Barbell Press | shoulders, triceps | ✅ alias | 0091 | gif |  | ExerciseDB id=0091 "barbell seated overhead press" via RapidAPI |
| dumbbell-shoulder-press | Dumbbell Shoulder Press | shoulders, triceps | ✅ alias | 0405 | gif |  | ExerciseDB id=0405 "dumbbell seated shoulder press" via RapidAPI |
| pike-push-up | Pike Push-Up | shoulders, triceps | 🖼️ poster (reviewed) |  | poster |  | No faithful ExerciseDB demo — static poster + cues (reviewed). |
| barbell-row | Barbell Row | back, biceps | ✅ alias | 0027 | gif |  | ExerciseDB id=0027 "barbell bent over row" via RapidAPI |
| dumbbell-row | One-Arm Dumbbell Row | back, biceps | 🟨 alias(approx) | 0293 | gif |  | ExerciseDB id=0293 "dumbbell bent over row" via RapidAPI — two-arm dumbbell row used for a one-arm movement |
| inverted-row-band | Band / Table Inverted Row | back, biceps | ✅ alias | 0499 | gif |  | ExerciseDB id=0499 "inverted row" via RapidAPI |
| lat-pulldown | Lat Pulldown | back, biceps | ✅ alias | 2330 | gif |  | ExerciseDB id=2330 "cable lat pulldown full range of motion" via RapidAPI |
| pull-up | Pull-Up | back, biceps | ✅ alias | 0652 | gif |  | ExerciseDB id=0652 "pull-up" via RapidAPI |
| band-lat-pulldown | Band Lat Pulldown | back, biceps | 🟨 alias(approx) | 0198 | gif |  | ExerciseDB id=0198 "cable pulldown" via RapidAPI — cable pulldown substituted for band variant (no band pulldown in ExerciseDB) |
| back-squat | Barbell Back Squat | quads, glutes | ✅ alias | 0043 | gif |  | ExerciseDB id=0043 "barbell full squat" via RapidAPI |
| goblet-squat | Goblet Squat | quads, glutes | ✅ alias | 1760 | gif |  | ExerciseDB id=1760 "dumbbell goblet squat" via RapidAPI |
| bodyweight-squat | Bodyweight Squat | quads, glutes | ✅ alias | 3533 | gif |  | ExerciseDB id=3533 "quads (bodyweight squat)" via RapidAPI |
| romanian-deadlift | Romanian Deadlift | hamstrings, glutes, back | ✅ alias | 0085 | gif |  | ExerciseDB id=0085 "barbell romanian deadlift" via RapidAPI |
| dumbbell-rdl | Dumbbell Romanian Deadlift | hamstrings, glutes | ✅ alias | 1459 | gif |  | ExerciseDB id=1459 "dumbbell romanian deadlift" via RapidAPI |
| glute-bridge | Glute Bridge | glutes, hamstrings | ✅ alias | 3013 | gif |  | ExerciseDB id=3013 "low glute bridge on floor" via RapidAPI |
| incline-walk | Incline Treadmill Walk | cardio | 🚶 cardio (static) |  | cardio_static |  | Cardio/locomotion — no form video needed; follow the cues. |
